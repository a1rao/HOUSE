 ...
 */
 exports.createClient = function(options) {
  ...
  options = options || {};
  var makeApiCall = require('@google/maps/lib/internal/make-api-call').inject(options);
  var deprecate = require('@google/maps/lib/util').deprecate;
  ...
  var geocode = require('@google/maps/lib/apis/geocode');
  var geolocation = require('@google/maps/lib/apis/geolocation');
  var timezone = require('@google/maps/lib/apis/timezone');
  var directions = require('@google/maps/lib/apis/directions');
  var distanceMatrix = require('@google/maps/lib/apis/distance-matrix');
  var elevation = require('@google/maps/lib/apis/elevation');
  var roads = require('@google/maps/lib/apis/roads');
  var places = require('@google/maps/lib/apis/places');
...
exports.cli = require('@google/maps/lib/internal/cli');
exports.util = require('@google/maps/lib/util');
