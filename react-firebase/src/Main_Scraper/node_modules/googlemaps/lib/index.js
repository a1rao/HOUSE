 ...
 * Internal modules
 */
var _makeRequest      = require('googlemaps/lib/utils/makeRequest');
var _assignParams     = require('googlemaps/lib/utils/assignParams');
var _jsonParser       = require('googlemaps/lib/utils/jsonParser');
var _encodePolyline   = require('googlemaps/lib/utils/encodePolylines');
var _getDefaultConfig = require('googlemaps/lib/config/getDefault');
var _constants        = require('googlemaps/lib/config/constants');
...
var api = {
  placeSearchText:        require('googlemaps/lib/placeSearchText'),
  placeSearch:            require('googlemaps/lib/placeSearchNearby'),
  placeDetails:           require('googlemaps/lib/placeDetails'),
  placeAutocomplete:      require('googlemaps/lib/placeAutocomplete'),
  geocode:                require('googlemaps/lib/geocode'),
  reverseGeocode:         require('googlemaps/lib/reverseGeocode'),
  distance:               require('googlemaps/lib/distance'),
  directions:             require('googlemaps/lib/directions'),
  elevationFromLocations: require('googlemaps/lib/elevationFromLocations'),
  // TODO
  // move this into an internal module + fix integration test
  // elevationFromPath:      require('./elevationFromPath'),
  staticMap:              require('googlemaps/lib/staticMap'),
  streetView:             require('googlemaps/lib/streetView'),
  timezone:               require('googlemaps/lib/timezone')
}
