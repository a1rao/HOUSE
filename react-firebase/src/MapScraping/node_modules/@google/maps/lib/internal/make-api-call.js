...
var url = require('url');
var Task = require('@google/maps/lib/internal/task');
...
exports.inject = function(options) {
  ...
  var makeUrlRequest = options.makeUrlRequest || require('@google/maps/lib/internal/make-url-request');
  ...
  var wait = require('@google/maps/lib/internal/wait').inject(mySetTimeout, myClearTimeout);
  var attempt = require('@google/maps/lib/internal/attempt').inject(wait).attempt;
  var ThrottledQueue = require('@google/maps/lib/internal/throttled-queue').inject(wait, getTime);
